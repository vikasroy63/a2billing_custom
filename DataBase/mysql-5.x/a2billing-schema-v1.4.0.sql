...
--
-- Table structure for table `cc_number`
--

CREATE TABLE IF NOT EXISTS `cc_number` (
  `id` bigint(20) NOT NULL auto_increment,
  `id_cc_numbergroup` bigint(20) NOT NULL,
  `id_cc_number_filter` int(11) NOT NULL,
  `prefix` int(11) default '0',
  `customprefix` int(11) default '0',
  `numbertype` int(11) default '0',
  ...
  `asr` int(11) default '0',
  `answered` int(11) default '0',
  `total` int(11) default '0',
  PRIMARY KEY  (`id`),
  UNIQUE KEY `cons_cc_number_number` (`number`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=1 ;

--
-- Dumping data for table `cc_number`
--
...
--
-- Table structure for table `cc_numbergroup`
--

CREATE TABLE IF NOT EXISTS `cc_numbergroup` (
  `id` bigint(20) NOT NULL auto_increment,
  `numbergroupname` char(50) collate utf8_bin NOT NULL,
  `id_cc_number_filter` int(11) NOT NULL,
  `prefix` int(11) default '92',
  `customprefix` int(11) default '101',
  `limit` int(11) default '0',
  `saved` int(11) default '0',
  `lastsaved` int(11) default '0',
  `acd` int(11) default '0',
  `asr` int(11) default '0',
  ...
  PRIMARY KEY  (`id`),
  UNIQUE KEY `cons_cc_numbergroup_numbergroupname` (`numbergroupname`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=1 ;

--
-- Dumping data for table `cc_numbergroup`
--
...
--
-- Table structure for table `cc_number_filter`
--

CREATE TABLE IF NOT EXISTS `cc_number_filter` (
  `id` bigint(20) NOT NULL auto_increment,
  `filtername` char(50) collate utf8_bin NOT NULL,
  `prefix` int(11) default '92',
  `customprefix` int(11) default '101',
  ...
  `activated` int(11) NOT NULL default '1',
  PRIMARY KEY  (`id`),
  UNIQUE KEY `cons_cc_number_filter_filtername` (`filtername`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=1 ;

--
-- Dumping data for table `cc_number_filter`
--
