...
CREATE TABLE cc_numbergroup (
    id 						BIGSERIAL NOT NULL,
    numbergroupname			TEXT NOT NULL,
    id_cc_number_filter		BIGINT NOT NULL,
    prefix 					INTEGER DEFAULT 92 NOT NULL,
    customprefix 			INTEGER DEFAULT 101 NOT NULL,
    limit 					INTEGER DEFAULT 0 NOT NULL,
    saved 					INTEGER DEFAULT 0 NOT NULL,
    lastsaved				INTEGER DEFAULT 0 NOT NULL,
    acd 					INTEGER DEFAULT 0 NOT NULL,
...
CREATE TABLE cc_number (
    id 							BIGSERIAL NOT NULL,
    id_cc_numbergroup 			BIGINT NOT NULL,
    id_cc_number_filter			INTEGER NOT NULL,
    prefix   					INTEGER DEFAULT 0,
    customprefix   				INTEGER DEFAULT 0,
...
-- numbertype: 0 = cid, 1= dnid
-- category: 0 = whitelist, 1= blacklist


CREATE TABLE cc_number_filter (
    id 								BIGSERIAL NOT NULL,
