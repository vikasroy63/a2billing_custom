...
<ul id="nav">
	...
	{else}
	src="templates/{$SKIN_NAME}/images/plus.gif"
	{/if} onmouseover="this.style.cursor='hand';" ></div> <div id="menutitlesection"><strong>{php} echo gettext("NUMBER");{/php}</strong></div></div></a></li></div>
		<div class="tohide"
	{if ($section =="16")}
		style="">
	{else}
	...
	{/if}
		<ul>
			<li><ul>
				<li><a href="A2B_entity_number.php?section=16"> {php} echo gettext("Numbers");{/php}</a></li>
				<li><a href="A2B_entity_numbergroup.php?section=16">{php} echo gettext("Number Group");{/php}</a></li>
				<li><a href="A2B_entity_number_filter.php?form_action=ask-add&section=16">{php} echo gettext("Filter");{/php}</a></li>
			</ul></li>
		</ul>
	</div>
	...
	{/if}
		<ul>
			<li><ul>
				<li><a href="A2B_entity_alarm.php?section=17"> {php} echo gettext("Alarms");{/php}</a></li>
				<li><a href="A2B_entity_log_viewer.php?section=17">{php} echo gettext("Users Activity");{/php}</a></li>
				<li><a href="A2B_entity_backup.php?form_action=ask-add&section=17">{php} echo gettext("Database Backup");{/php}</a></li>
				<li><a href="A2B_entity_restore.php?section=17">{php} echo gettext("Database Restore");{/php}</a></li>
				<li><a href="CC_musiconhold.php?section=17">{php} echo gettext("MusicOnHold");{/php}</a></li>
				<li><a href="CC_upload.php?section=17">{php} echo gettext("Upload File");{/php}</a></li>
				<li><a href="A2B_logfile.php?section=17">{php} echo gettext("Watch Log files");{/php}</a></li>
				<li><a href="A2B_data_archiving.php?section=17">{php} echo gettext("Archiving");{/php}</a></li>
				<li><a href="A2B_asteriskinfo.php?section=17">{php} echo "Asterisk Info";{/php}</a></li>
				<li><a href="A2B_phpsysinfo.php?section=17">{php} echo "phpSysInfo";{/php}</a></li>
				<li><a href="A2B_phpinfo.php?section=17">{php} echo "phpInfo";{/php}</a></li>
				<li><a href="A2B_entity_monitor.php?section=17"> {php} echo gettext("Monitoring");{/php}</a></li>
			</ul></li>
		</ul>
	</div>
	...
	{/if}
		<ul>
			<li><ul>
				<li><a href="A2B_entity_mailtemplate.php?atmenu=mailtemplate&section=18&languages=en">{php} echo gettext("Mail templates");{/php}</a></li>
				<li><a href="A2B_mass_mail.php?section=18">{php} echo gettext("Mass Mail");{/php}</a></li>
			</ul></li>
		</ul>
	</div>
	{/if}
	...
	{if ($ACXSETTING  > 0)}
	<div class="toggle_menu"><li>
	<a href="javascript:;" class="toggle_menu" target="_self"> <div> <div id="menutitlebutton"> <img id="img19"
	{if ($section == "19")}
	src="templates/{$SKIN_NAME}/images/minus.gif"
	{else}
	src="templates/{$SKIN_NAME}/images/plus.gif"
	...
	{/if}
		<ul>
			<li><ul>
				<li><a href="A2B_entity_config.php?form_action=list&atmenu=config&section=19">{php} echo gettext("Global List");{/php}</a></li>
				<li><a href="A2B_entity_config_group.php?form_action=list&atmenu=configgroup&section=19">{php} echo gettext("Group List");{/php}</a></li>
				<li><a href="A2B_entity_config_generate_confirm.php?section=19">{php} echo gettext("Add agi-conf");{/php}</a></li>
				<li><a href="phpconfig.php?dir=/etc/asterisk&section=19">{php} echo gettext("* Config Editor");{/php}</a></li>
